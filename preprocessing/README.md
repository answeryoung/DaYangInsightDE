## Data Source
The origional data is collected and processed by
...
The files was downloaded to an EC-2 instance with a 240 GB storage attached. The set of files can be downloded with this command:
...
Overall, the set of .json files is data set suited to simulate a data stream of identical schema at a frequency of upto 10,000 messages per second and a speed of upto 250 Mbps.