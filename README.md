...
## Objective
The goal is near real-time processing and forwarding electrocardiography (ECG or EKG) data to care providers and aggregate these data (data aggregation can be electively disabled).
...
The Kafka would occasionally lose over half the messages sent by the producer program. I speculate the cause being this project does not use in this project. The workaround I implemented is for every 500 messages produced by a producer program, the thread sleep for 1 ms.
